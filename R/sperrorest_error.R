    ...
    if (is.factor(obs)) {
        if (is.factor(pred)) { # "hard" classification:
            ...
            if (nlevels(obs) == 2) {
                ...
                ntruepos = sum( (obs == levels(obs)[2]) & 
                                  (pred == levels(obs)[2]) )
                ntrueneg = sum( (obs == levels(obs)[1]) & 
                                  (pred == levels(obs)[1]) )
