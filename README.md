...
`partition_kmeans()`has been integrated into [mlr](https://github.com/mlr-org/mlr) (see [2ebd2f](https://github.com/mlr-org/mlr/commit/2ebd2f29bb8adcf5f865ca3a6b579c71ca96c072)). `sperrorest` is currently not actively developed. We recommend to use [mlr](https://github.com/mlr-org/mlr) for all future (spatial) cross-validation work.
