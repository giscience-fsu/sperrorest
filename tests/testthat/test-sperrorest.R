...
test_that("output length of list is correct for par_mode = 'foreach'
          on rpart example", {
...
test_that("sperrorest() variable importance for 'foreach' mode", {
...
test_that("par_mode = 'apply' works with var_imp", {
...
test_that("output length of list is correct for par_mode = 'sequential'
          on rpart example", {
...
test_that("sequential variable importance", {
