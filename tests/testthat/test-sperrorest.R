...
pacman::p_load(
  sperrorest, testthat, rpart, MASS, foreach, doFuture, future,
...
test_that("sperrorest correctly updates resampling object when
  ...
  expect_lt(
    length(out[["represampling"]][["1"]][["1"]][["test"]]),
    150
  )
})
...
test_that("sperrorest() when missing factor levels in train data", {
  ...
  readRDS(paste0(
    "/Users/pjs/Servers/GIServer/home/shares/data/LIFE/mod/",
